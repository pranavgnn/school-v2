...
function prompt(message, time, content) {
    ...
    message.channel.awaitMessages(filter, { time: time * 60 * 1000, max: 1, errors: ['time'] })
        .then(responses => {
...
exports.run = async (bot, message, args) => {
    ...
    var msg = await message.channel.send(`Submitting the assignment answers to students' Direct Messages... Please wait.`)
    ...
    msg.edit(`Successfully sent your assignment to all students' Direct Messages.`)
};